...
export const usageLogSchema = z.object({
  ...
  token_remain_quota: z.number().nullish(),
  token_used_quota: z.number().nullish(),
  token_unlimited_quota: z.boolean().nullish(),
  display_remain_quota: z.number().nullish(),
  display_unlimited_quota: z.boolean().nullish(),
