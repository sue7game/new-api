...
const EditChannelModal = (props) => {
  ...
  const originInputs = {
    ...
    pass_through_content_enabled: false,
    system_prompt: '',
    ...
    if (success) {
      ...
      if (data.setting) {
        try {
          ...
          data.pass_through_content_enabled =
            parsedSettings.pass_through_content_enabled || false;
          ...
          data.pass_through_content_enabled = false;
          data.system_prompt = '';
      ...
      setChannelSettings({
        ...
        pass_through_content_enabled: data.pass_through_content_enabled,
  ...
  const submit = async () => {
    ...
    const channelExtraSettings = {
      ...
      pass_through_content_enabled:
        localInputs.pass_through_content_enabled || false,
    ...
    delete localInputs.pass_through_content_enabled;
              ...
              <div className='p-2 space-y-3' ref={formContainerRef}>
                ...
                >
                  <Card className='!rounded-2xl shadow-sm border-0 mb-6'>
                    ...
                    <Form.Switch
                      field='pass_through_content_enabled'
                      label={t('透传请求内容')}
                      checkedText={t('开')}
                      uncheckedText={t('关')}
                      onChange={(value) =>
                      ...
                      extraText={t('启用请求内容透传功能（保留参数覆写/模型重定向）')}
                    />
